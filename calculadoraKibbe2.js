// Inicializando o objeto de contagem para as respostas A, B, C, D, E
const answerCount = {
    A: 0,
    B: 0,
    C: 0,
...
// Função para fazer as perguntas e contar as respostas
function askQuestion(question, options) {
    let answer = prompt(question + "\n" + options);
    
    // Condicionais para contar a letra escolhida
...
// Função para determinar o tipo Kibbe com base nas respostas mais recorrentes
function calculateKibbeType() {
    const { A, B, C, D, E } = answerCount;

    let result = "";

    // Lógica para determinar o tipo Kibbe com base nas respostas
    if (A > B && A > C && A > D && A > E) {
        result = "Dramática";
    } else if (A > C && (D > B || E > B)) {
        result = "Dramática Suave";
    } else if (B > A && B > C && B > D && B > E) {
        result = "Natural";
    } else if (B > C && A > B) {
        result = "Natural Extravagante";
    } else if (B > A && (D > C || E > C)) {
        result = "Natural Suave";
    } else if (C > A && C > B && C > D && C > E) {
        result = "Clássica";
    } else if (C > A && (A > B || B > A)) {
        result = "Clássica Dramática";
    } else if (C > A && (D > B || E > B)) {
        result = "Clássica Suave";
    } else if (A > C && E > C) {
        result = "Gamine";
    } else if (A > C && E > C && B > D) {
        result = "Gamine Extravagante";
    } else if (A > C && E > C && D > B) {
        result = "Gamine Suave";
    } else if (D > E && A > D) {
        result = "Romântica Teatral";
